...
| LAI-T-011 | Add scoped EPUB test-run parameters (`--limit-docs`, page/chapter range) | Ready for review | Task | Reduce end-to-end test time on large books | Added CLI options `--limit-docs`, `--start-doc`, `--end-doc` with validation and EPUB doc-selection logic in translator | 2026-04-11T22:08:25+07:00 | 2026-04-11T22:14:44+07:00 |
